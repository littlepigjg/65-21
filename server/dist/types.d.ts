...
export type AuditEventType = 'file_create' | 'file_modify' | 'file_delete' | 'sync_execute' | 'sync_skip' | 'conflict_detect' | 'conflict_resolve' | 'system_start' | 'system_stop' | 'sync_cycle_start' | 'sync_cycle_end';
